...
////////////////////////////////////////////////////
//класс эллипс
class CEllipse : public CBasePoint
{
...
public:
	// Конструкторы
	CEllipse(int x, int y, WORD s, int finishX = 0, int finishY = 0);
	CEllipse();
	~CEllipse() {};
	//Методы
		// Отображает фигуру на экране
