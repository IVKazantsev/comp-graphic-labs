...
public:
	...
	HCURSOR m_hcurSquare;	// ������ �������
	HCURSOR m_hcurPolygon;	// ������ ��������� ��� �������
	HCURSOR m_hcurSurface;	// ������ �����������
	HCURSOR m_hcurEllipse;
	HCURSOR m_hcurPng;
	HCURSOR m_hcurBezier;
...
protected:
	...
	afx_msg void OnEditAddshapeEllipse();
	afx_msg void OnEditAddshapePng();
	afx_msg void OnEditAddshapeBezier();
