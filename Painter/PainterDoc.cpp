	...
	else // ���������
	{
		...
		switch(version_n) // � ����������� �� ������ ������� 
		{
			case 2:
				...
				{
					ar >> point;
					if (((CPolygon*)pPolygon)->m_PointsArray.GetSize() == 0) {
						((CPolygon*)pPolygon)->m_PointsArray.Add(point);
						((CPolygon*)pPolygon)->m_PointsArray.Add(CPoint(point.x + 1000, point.y - 2000));
						((CPolygon*)pPolygon)->m_PointsArray.Add(CPoint(point.x, point.y - 4000));
						((CPolygon*)pPolygon)->m_PointsArray.Add(CPoint(point.x - 1000, point.y - 2000));
					}
				}
			case 3:
